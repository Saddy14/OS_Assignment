...
public class Event {
	...
	//By wrapping the code inside SwingUtilities.invokeLater, you ensure that this action listener's logic runs on the EDT, preventing any threading issues when manipulating Swing components.
