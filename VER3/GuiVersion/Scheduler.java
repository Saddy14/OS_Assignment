...
public abstract class Scheduler {
	...
	private List<Process> processInputList; // Process Input = data collected in every processInput
	private List<Process> processOutputList; // Process Output = result after running scheduler
