...
public class GUI extends JFrame {
	...
	private void addCalculationSection() {
        ...
        avgWTTxtField = createTextField(219, 380, 150, 40);

        addLabel("Total Waiting Time :", 40, 430, 175, 40);
        totalWTTxtField = createTextField(219, 430, 150, 40);

        addLabel("Average Turnaround Time :", 389, 380, 188, 40);
        avgTATTxtField = createTextField(585, 380, 150, 40);

        addLabel("Total Turnaround Time :", 389, 430, 188, 40);
        totalTATTxtField = createTextField(585, 430, 150, 40);
    }
